...
module.exports = async function handler(req, res) {
  ...
  res.setHeader('Access-Control-Allow-Origin', 'https://qcag-survey-app.vercel.app');
  ...
  // Only allow calls from our own frontend origin
  const origin = String(req.headers.origin || req.headers.referer || '');
  const allowed = origin.startsWith('https://qcag-survey-app.vercel.app') || origin.startsWith('http://localhost');
